...
{
	union {
		intvector calculate_average_1_arg;
		intvector find_max_min_1_arg;
		product multiply_scalar_1_arg;
	} argument;
	char *result;
	...
	case calculate_average:
		_xdr_argument = (xdrproc_t) xdr_intvector;
		_xdr_result = (xdrproc_t) xdr_float;
		local = (char *(*)(char *, struct svc_req *)) calculate_average_1_svc;
		break;

	case find_max_min:
		_xdr_argument = (xdrproc_t) xdr_intvector;
		_xdr_result = (xdrproc_t) xdr_intpair;
		local = (char *(*)(char *, struct svc_req *)) find_max_min_1_svc;
		break;

	case multiply_scalar:
		_xdr_argument = (xdrproc_t) xdr_product;
		_xdr_result = (xdrproc_t) xdr_floatvector;
		local = (char *(*)(char *, struct svc_req *)) multiply_scalar_1_svc;
		break;
